 ...
 Export-WindowsImage -SourceImagePath "C:\ISOs\OS\Clients\Win11\24H2\sources\install.wim" -SourceIndex 6  -DestinationName 'Windows 11 Enterprise 24H2' -DestinationImagePath $WIMDestination
 }
