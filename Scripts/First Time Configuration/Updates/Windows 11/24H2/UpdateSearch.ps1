...
$CumulativeUpdates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-Cumulative.txt"
...
$SecurityUpdates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-Security.txt"
...
$NET8Updates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-NET8Client.txt"
...
$NET7Updates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-NET7Client.txt"
...
$NET6Updates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-NET6Client.txt"
...
$NET5Updates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-NET5Client.txt"
...
$MSEdgeUpdates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-Edge.txt"
...
$PowerShellUpdates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-PowerShell.txt"
...
$WACUpdates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-WindowsAdminCentert.txt"
...
$AVUpdates | Select-Object Title, Guid | Out-File "C:\Updates List\Windows11-24H2-AV.txt"
