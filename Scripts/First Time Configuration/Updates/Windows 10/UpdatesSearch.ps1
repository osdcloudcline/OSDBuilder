...
$CumulativeUpdates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-Cumulative.txt"
...
$SecurityUpdates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-Security.txt"
...
$NET8Updates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-NET8Client.txt"
...
$NET7Updates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-NET7Client.txt"
...
$NET6Updates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-NET6Client.txt"
...
$NET5Updates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-NET5Client.txt"

Write-Host
Write-Host "Retriving Windows 10 Microsoft Edge Updates..." -ForegroundColor Cyan
$MSEdgeUpdates = Get-MSCatalogUpdate -Search "Edge" 
$MSEdgeUpdates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-Edge.txt"
...
$PowerShellUpdates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-PowerShell.txt"
...
$WACUpdates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-WindowsAdminCenter.txt"
...
$AVUpdates | Select-Object Title, Guid | Out-File "E:\Updates\Windows10\Windows10-AV.txt"
